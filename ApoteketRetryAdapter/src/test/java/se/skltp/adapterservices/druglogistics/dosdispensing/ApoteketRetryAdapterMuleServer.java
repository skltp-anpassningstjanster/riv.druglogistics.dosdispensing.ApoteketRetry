...
public class ApoteketRetryAdapterMuleServer {


	public static final String MULE_SERVER_ID   = "ApoteketRetryAdapter";
 

	private static final Logger logger = LoggerFactory.getLogger(ApoteketRetryAdapterMuleServer.class);
	...
	public static void main(String[] args) throws Exception {
        ...
        //         Note: Actually enables the spring-beans-profile "soitoolkit-teststubs" in the file "src/main/app/ApoteketRetryAdapter-common.xml"
        //
